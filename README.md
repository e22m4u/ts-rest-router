...
- [Производительность: Маршрутизация на префиксном дереве](#производительность-маршрутизация-на-префиксном-дереве)
...
## Производительность: Маршрутизация на префиксном дереве

В основе данного модуля лежит
[@e22m4u/js-trie-router](https://www.npmjs.com/package/@e22m4u/js-trie-router),
который использует структуру данных **префиксного дерева (Trie)** для
хранения маршрутов и их сопоставления. Такое архитектурное решение
